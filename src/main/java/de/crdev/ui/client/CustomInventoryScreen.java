...
public class CustomInventoryScreen extends HandledScreen<CustomInventoryScreenHandler> {
    private static final Identifier TEXTURE = new Identifier(TheCureMod.MOD_ID, "textures/gui/potion_gauntlet_inventory.png");
